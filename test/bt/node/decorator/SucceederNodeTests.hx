...
class SucceederNodeTests extends Test {
	public function test_when_execute_is_called_and_the_child_node_is_failing_it_should_return_success() {
	...
	public function test_when_execute_is_called_and_the_child_node_is_successful_it_should_return_success() {
